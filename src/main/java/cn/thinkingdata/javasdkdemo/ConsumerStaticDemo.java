package cn.thinkingdata.javasdkdemo;
...
public class ConsumerStaticDemo {


    public static void main(String[] args) throws Exception {
        //ThinkingDataAnalytics tga = new ThinkingDataAnalytics(new ThinkingDataAnalytics.LoggerConsumer("F:\\home\\sdk\\log", 100)); //使用loggerConsumer
		ThinkingDataAnalytics tga = new ThinkingDataAnalytics(new ThinkingDataAnalytics.BatchConsumer("http://sdk.tga.thinkinggame.cn:9080/logagent", "test-logagent")); //使用batchConsumer ,设置你的上传数据的APPID，以及地址
